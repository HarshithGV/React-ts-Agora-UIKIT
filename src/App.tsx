...
const rtcProps = {
    ...
    channel: "Navatar",
    token: "007eJxTYPA8zHy/8HSH2q4bswxEd17TXKOzsd2/raMm6j3j7y2m7RoKDMmWRiZJKWZpSabmSSYmSYYWBpbJBuYmZknmFhbmpikWVXK2KQ2BjAwd+zhZGRkgEMRnZ/BLLEssSSxiYAAAmr0fhg==",
};
const callbacks = {
